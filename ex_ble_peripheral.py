"""
Example code downloaded from https://github.com/mongodb-developer/BLE-periph-MP-RP2

BLE Peripheral for Raspberry Pi Pico (RP2) with Temperature Measurement

Description:
This MicroPython code serves as a BLE Peripheral for Raspberry Pi Pico (RP2) W. 
It measures temperature from the on-board sensor and exposes it through BLE, allowing readings or notification requests.

Edit and Run:
To use this code, ensure you have MicroPython installed on your RP2. 
It is recommended to use VSCode with the MicroPico extension. 
If using VSCode, run "MicroPico: Configure Project" to execute the code from the editor. 
Alternatively, you can use other editors like Emacs with mpremote or Thonny.
